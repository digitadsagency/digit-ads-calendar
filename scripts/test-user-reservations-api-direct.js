...
// Simular la función getAllUserReservationsWithCancelled exactamente como está en el código
...
async function testUserReservationsAPIDirect() {
  try {
    console.log('🧪 Probando API de reservas de usuarios directamente...');
    
    // Probar con diferentes usuarios que sabemos que existen
    const testUserIds = ['USR-CE17A2', 'USR-1F1967', 'USR-TEST123'];
...
if (require.main === module) {
  testUserReservationsAPIDirect();
}

module.exports = { testUserReservationsAPIDirect };
